            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View>
                        ...
                        <ThemedText style={{ fontWeight: 'bold' }}>{item.request.content.body}</ThemedText>
                        <ThemedText style={{ fontWeight: 'bold' }}>{JSON.stringify(item.request.content.data, null, 2)}</ThemedText>
                    </View>
                )}
